...
public class Ex02_variable {
	...
	public static void main(String[] args) {
		...
		System.out.println(Integer.MIN_VALUE); // 최소 가용 범위
		System.out.println(Integer.MAX_VALUE); // 최대 가용 범위
		int myAge = 24;
		System.out.println(myAge);
		
		// 4. long 타입 (초과되는 숫자는 long 타입으로)
		//	1) 8바이트
		//	2) 정수
		//	3) suffix(접미사)가 L(l)
		...
		// 8. String 클래스 타입 (첫글자가 대문자면 Class)
		...
		System.out.println(myName.hashCode()); //참조값
